...
namespace FlightMath.Migrations
{
    ...
    [Migration("20201205120133_AddLinks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirportMainData", b =>
                {
                    b.Property<decimal>("AirportsSequence")
                        .HasColumnType("numeric(18,0)");

                    b.Property<decimal>("MainDatasSequence")
                        .HasColumnType("numeric(9,0)");

                    b.HasKey("AirportsSequence", "MainDatasSequence");

                    b.HasIndex("MainDatasSequence");

                    b.ToTable("AirportMainData");
                });
            ...
            modelBuilder.Entity("AirportMainData", b =>
                {
                    b.HasOne("FlightMath.Airport", null)
                        .WithMany()
                        .HasForeignKey("AirportsSequence")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FlightMath.Models.MainData", null)
                        .WithMany()
                        .HasForeignKey("MainDatasSequence")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
